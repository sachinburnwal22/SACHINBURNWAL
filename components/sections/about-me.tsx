      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <motion.div variants={item} className="space-y-5">
            ...
            >
              I’m Sachin Burnwal, a passionate Web Developer with a hacker’s
              curiosity and a creator’s mindset. My journey blends full-stack
              development with cybersecurity insights, giving me a unique edge
              in building applications that are not only dynamic and visually
              immersive but also robust and secure.
            </motion.p>
            <motion.p
              variants={item}
              className="text-pretty leading-relaxed text-foreground/90"
            >
              I specialize in crafting modern, animated, and interactive web
              experiences using React, Three.js, GSAP, Tailwind, and Framer
              Motion. On the backend, I work with Node.js, Express, Sequelize
              (MySQL), MongoDB, and Puppeteer automation, delivering seamless
            ...
            <motion.p
              ...
              className="text-pretty leading-relaxed text-foreground/90"
            >
              I love pushing boundaries — whether it’s building cyber-themed
              projects like SpiderWeb, experimenting with 3D interactive UI, or
              automating complex tasks with AI APIs and Puppeteer. For me,
              development isn’t just about code; it’s about designing
              experiences that leave people saying “Whoa, that’s different!”
            </motion.p>
            <motion.p
              variants={item}
              className="text-pretty leading-relaxed text-foreground/90"
            >
              ...
              cybersecurity techniques, AI tools, or breaking down complex
              problems into elegant solutions.
            </motion.p>
            <motion.blockquote
              variants={item}
              className="border-l-2 border-primary pl-4 text-foreground/90"
            >
              ✨ My motto: “Create, break, learn, and build again — stronger,
              faster, smarter.”
            </motion.blockquote>
            ...
            <motion.div variants={item} className="flex flex-wrap gap-3 pt-2">
              ...
              <a
                href="https://drive.google.com/uc?export=download&id=11ITENZ8IzQoGX0RgFY3Le8vIt3uklv1S"
