...
const certifications = [
  {
    ...
    date: "2024",
    description:
      "Comprehensive front-end development certification covering React, JavaScript, and modern web technologies.",
  ...
  },
  {
    ...
    date: "2024",
    description:
      "Cybersecurity fundamentals, network security, and threat detection methodologies.",
  ...
  },
  {
    ...
    date: "2024",
    description:
      "Cloud computing fundamentals and AWS services for scalable applications.",
